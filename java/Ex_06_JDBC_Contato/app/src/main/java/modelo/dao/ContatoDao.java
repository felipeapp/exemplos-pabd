...
public class ContatoDao extends AbstratoDao {
    ...
    public boolean atualizarNomeNumeroPorEmail(String email, String novo_nome, int novo_celular) {
        boolean sucesso;
    ...
    public List<Contato> buscarPorSimilaridadeNome(String nome) {
        List<Contato> contatos = new ArrayList<Contato>();
